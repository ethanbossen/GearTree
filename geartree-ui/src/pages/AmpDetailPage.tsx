...
import type { Amplifier, AmplifierDetail } from "../types";
import GenericDetailPage from "../components/GenericDetailPage";
import { Badge, Group, Text } from "@mantine/core";

function AmpDetailPage() {
  const renderAmpMetadata = (amp: Amplifier) => (
    <div className="space-y-3">
      {/* Price info in subtitle */}
  ...
  const getAmpRelatedSections = (amp: Amplifier) => [
    {
      key: 'relatedAmps',
      title: 'Related Amps:',
      basePath: 'amplifiers',
  ...
  return (
    <GenericDetailPage<AmplifierDetail>
      apiService={Amps}
      entityName="amplifier"
